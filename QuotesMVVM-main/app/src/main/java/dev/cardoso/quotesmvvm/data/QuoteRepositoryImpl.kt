...
class QuoteRepositoryImpl @Inject constructor (quoteDAO: QuoteDAO, var localDataSource: QuoteLocalDataSourceImpl, var remoteDataSource: QuoteRemoteDataSourceImpl ): QuoteRepository {
